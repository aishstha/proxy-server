...
/* package third-0.1.0.0 */
#ifndef VERSION_third
#define VERSION_third "0.1.0.0"
#endif /* VERSION_third */
#ifndef MIN_VERSION_third
#define MIN_VERSION_third(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_third */
...
#define CURRENT_COMPONENT_ID "third-0.1.0.0-FMdULiGtpcm4D1LlFQvkt-third"
